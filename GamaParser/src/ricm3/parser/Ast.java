...
public class Ast {
	...
	public static class Action extends Ast {
		...
		//exec : appeller une fonction de l'entité
	}
	...
	public static class Automaton extends Ast {
		...
		// exec :   recuperer le bon behaviour
		//			exec sur le behaviour
	}
	...
	public static class Behaviour extends Ast {
		...
		// exec : parcourir la liste des transitions, eval sur chaque condition pour recuperer la bonne
	}
	...
	public static class Transition extends Ast {
		...
		// exec : faire action + changer etat courant
	}
}
