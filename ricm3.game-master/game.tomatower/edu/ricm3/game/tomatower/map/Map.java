				...
				for (int col = 0; col < line_elements.length; col++) {
					...
					case "P":
						...
						this.model.setPlayer(new Player(this.model, this.model.getSprites().sprite_player, 1, cell,
								Direction.UP, w, this.model.getSprites().sprite_player_run));
						break;
					case "Os":
					...
					case "C":
						if (main_crystal == null) {
							...
							new Crystal(this.model, this.model.getSprites().sprite_crystal, 0, cell,
					...
					case "Po":
						...
						break;
					case "Suy":
						new Upgrade(this.model, this.model.getSprites().sprite_upgrade_yellow, 1, cell,
								ObstaclesKind.UPGRADE, this.model.getWeapons().get("yellow"), 200);
						break;
					case "Sur":
						new Upgrade(this.model, this.model.getSprites().sprite_upgrade_red[0], 1, cell,
								ObstaclesKind.UPGRADE, this.model.getWeapons().get("red"), 200);
						break;
					case "Str":
						new Product(this.model, this.model.getSprites().sprite_tower_red[0], 1, cell,
								ObstaclesKind.UPGRADE, this.model.getWeapons().get("red"), 1000);
						break;
					}
				}
