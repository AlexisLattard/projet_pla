...
public class Model extends GameModel {
    ...
    public void initModel(Controller c) {
        ...
        //TEST
        new Mobs(this, this.getSprites().sprite_mobs, 1, this.getMainMap().getCell(6, 10), Direction.WEST, this.getWeapons().get(Kind_Weapon.Red), this.automatons.get("FollowTheWalls"));
        ...
        new Mobs(this, this.getSprites().sprite_mobs, 1, this.getMainMap().getCell(4, 4), Direction.WEST, this.getWeapons().get(Kind_Weapon.Yellow), this.automatons.get("FollowTheWalls"));
