...
public class Model extends GameModel {
    ...
    public void initModel(Controller c) {
        ...
        this.initMaps();
        //TEST
        new Mobs(this, this.getSprites().sprite_mobs, 1, this.getMainMap().getCell(1, 1), Direction.WEST, this.getWeapons().get(Kind_Weapon.Red), this.automatons.get("FollowTheWalls"));
