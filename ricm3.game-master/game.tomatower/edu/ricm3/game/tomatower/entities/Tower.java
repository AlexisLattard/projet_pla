...
public class Tower extends Living {
	...
	public Tower(Model c_model, BufferedImage c_sprite[], Weapon c_weapon, BufferedImage c_sprite_run[][]) {
		super(c_model, false, c_sprite, 1, Direction.LEFT, c_weapon, initColisions(), c_sprite_run);
		// this.model.addTower(this);
	}
